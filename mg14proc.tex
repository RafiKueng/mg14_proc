...
as written in \icite{sw1} blabla

\section{Creating and Selecting Modells}

\section{Determing Lensing Mass}

\section{Determing Stellar Mass}
...
We determine the total (lensing) mass \Mlens of the candidates using the generated models and the stellar mass \Mstel using an interpolation with redshifts given in \icite{sw2} and the Salpeter Initial Mass Function (\icite{Salpeter1955}).
