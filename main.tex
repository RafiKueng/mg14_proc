...
\begin{abstract}
In SpaceWarps, a community of over 30\,000 % note: SI rule forbids to use , or . for separation of 1000th (9. conference, 1948, Resolution 7) http://www.bipm.org/en/CGPM/db/9/7/
...
In this work, we present \spl and a novel extension that facilitates the cooperation among the volunteers.
...
In this work we use the method presented and tested in \icite{Kueng2015} to create models of all lens candidates discovered by the first run of \sw.\scite{sw2}
